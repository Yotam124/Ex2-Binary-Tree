...
int main() {
  ...
  .CHECK_EQUAL (mytree.root(), 50)
  .CHECK_EQUAL (mytree.right(mytree.Root->value), 75)
  .CHECK_EQUAL (mytree.left(mytree.Root->value), 25)
  .CHECK_EQUAL (mytree.size(), 7)
  .CHECK_EQUAL (mytree.contains(75), true)
  .CHECK_OK (mytree.remove(75))
  .CHECK_EQUAL (mytree.size(), 6)
  .CHECK_EQUAL (mytree.contains(75), false)
  ...
  .CHECK_EQUAL (mytree.parent(10), 25)
  .CHECK_EQUAL (mytree.left(25), 10)
  .CHECK_OK    (mytree.insert(90))
  .CHECK_EQUAL (mytree.parent(90), 60)
  .CHECK_EQUAL (mytree.right(60), 90)
